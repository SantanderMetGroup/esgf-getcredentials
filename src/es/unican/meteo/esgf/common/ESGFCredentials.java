...
public class ESGFCredentials {
	...
	/**
	 * Constructor
	 * @param x509userCertificate user x509 certificate
	 * @param privateKey user RSA private key
	 * @param x509ServerCertificates server certificates
	 */
	 ...
	 * @param x509userCertificate the x509 user certificate to set
	 */
	...
	/**
	 * Get a collection with the user certificates and other certificates if exists
	 * @return
	 */
