...
public class StoreUtil {
	 ...
	 * @throws IOException
	 */
	public static KeyStore generateJCEKSKeystore(
			X509Certificate userCertificate, PrivateKey privateKey,
			Collection<X509Certificate> otherCerts, String passwd)
	...
	public static KeyStore generateJKSKeystore(X509Certificate userCertificate,
			PrivateKey privateKey, Collection<X509Certificate> otherCerts,
			String passwd) throws GeneralSecurityException, IOException {
		// certificates [] <- user certificate and others
		Iterator<X509Certificate> iter = otherCerts.iterator();
		X509Certificate[] certificates = new X509Certificate[otherCerts.size() + 1];
		certificates[0] = userCertificate;
	 ...
	 * @throws IOException
	 */
	public static KeyStore loadJKSTrustStore(InputStream truststoreInput,
			String passwd) throws GeneralSecurityException, IOException {
