...
public class PemUtil {
    ...
    /**
     * Get fragment of PEM String. Trailing whitespace supported.
     * 
     * @param pem
    ...
    private static byte[] getFragmentOfPEM(String pem, String header,
        ...
        // read String line per line and remove whitespaces
    ...
    /**
     * Read certificates from pem and returns array of certificates. Trailing
     * whitespaces supported
     * 
     * @param pem
    ...
    public static void main(String[] args) {
        ...
        File file = new File("/home/terryk/.esg/credentials.pem");
        try {
            getPrivateKey(pemFileToString(file));
        } catch (IOException e) {
